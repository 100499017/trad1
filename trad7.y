...
%token PUTS          // NUEVO: identifica la función puts para imprimir cadenas
%token PRINTF        // NUEVO: identifica la función printf
...
programa:       declaraciones funcion_main  { sprintf (temp, "%s\n%s\n(main)", $1.code, $2.code) ;
                                              $$.code = gen_code (temp) ; }
            |   funcion_main                { sprintf (temp, "%s\n(main)", $1.code) ;
                                              $$.code = gen_code (temp) ; }
            ;
